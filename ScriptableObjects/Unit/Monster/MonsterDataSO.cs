...
public class MonsterDataSO : ScriptableObject
{
    ...
    public class EyeTypeData
    {
        ...
        [field: SerializeField][field: Range(0f, 30f)] public float BaseSpeed { get; private set; } = 15f;

        [field: Header("WalkData")]
        [field: SerializeField][field: Range(0f, 20f)] public float WalkSpeedModifier { get; private set; } = 1f;

        [field: Header("RunData")]
        [field: SerializeField][field: Range(0f, 40f)] public float RunSpeedModifier { get; private set; } = 1.8f;
    ...
    public class EarTypeData
    {
        ...
        [field: SerializeField][field: Range(0f, 150f)] public float ChaseRange { get; private set; } = 30f;
        ...
        [field: SerializeField][field: Range(0f, 30f)] public float BaseSpeed { get; private set; } = 4f;
